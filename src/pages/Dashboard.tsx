        ...
        <Dialog open={showOrderDetailModal} onOpenChange={setShowOrderDetailModal}>
          <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <DialogFooter className="flex flex-wrap gap-2 sm:gap-2">
              ...
              {selectedOrder?.delivery_phone && (
                <a
                  href={generateWhatsAppOrderLink(selectedOrder.delivery_phone, {
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 h-10 px-4 py-2 rounded-md bg-emerald-500 hover:bg-emerald-600 text-white font-medium transition-colors"
                >
